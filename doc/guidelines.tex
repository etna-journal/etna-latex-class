...
\item Equations that are not referenced should not be numbered. Packages
  like mathtools\footnote{\url{https://www.ctan.org/pkg/mathtools?lang=en}} or
  refcheck\footnote{\url{http://ctan.org/pkg/refcheck}} can aid with that task.
...
\item Table captions should be \emph{above} the table (unlike figure captions
  which should be below the figure).
\item The text of all captions (table or figure) should end with a period~`.'.
...
betterbib\footnote{\url{https://github.com/nschloe/betterbib}}
